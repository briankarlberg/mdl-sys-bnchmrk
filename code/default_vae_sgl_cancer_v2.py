...
from tensorflow.keras.layers import Input, Dense, Layer, Normalization, BatchNormalization
...
if __name__ == "__main__":
    ...
    loaded_data = pd.read_csv(args.data, sep="\t")
    ...
    data_system_2_cancer_enc = le.fit_transform(data_system_2_cancer)

    data_systems_2_system_enc = le.fit_transform(data_systems_2_system)
    data_systems_1_system_enc = le.fit_transform(data_systems_1_system)
    ...
    # add cancer after scaling
    data_system_1[cancer_column] = data_system_1_cancer_enc
    data_system_2[cancer_column] = data_system_2_cancer_enc

    # add systems after scaling
    data_system_1[systems_column] = data_systems_1_system_enc
    data_system_2[systems_column] = data_systems_2_system_enc
    ...
    _, _, latent_space = encoder.predict(data_combined)
    ...
    sns.scatterplot(x=embedding[:, 0], y=embedding[:, 1], hue=data_combined_cancer, palette="viridis", style=data_combined_systems)
